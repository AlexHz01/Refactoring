...
// console.log(explorers) Esto nos muestra todo lo de explorers.json

// Part 2: Get the quantity of explorers names in node
const explorersInNode = explorers.filter((explorer) => explorer.mission == "node");
// console.log(explorersInNode.length) esto nos filtra todos los explorers que estan en node

// Part4: Get the explorer's usernames in Node
const explorersInNodeToGetUsernames = explorers.filter((explorer) => explorer.mission == "node");
const usernamesInNode = explorersInNodeToGetUsernames.map((explorer) => explorer.githubUsername);
// console.log(usernamesInNode) esto nos recorre todo el escrip y nos muestra los nombre de los usuarios en node
